...
CREATE TABLE `user` (
  ...
  `survey` tinyint(1) DEFAULT '0' COMMENT 'true=1 / false = 0',
  `join_date` datetime DEFAULT CURRENT_TIMESTAMP,
  `profile_image` text COLLATE utf8mb4_unicode_ci,
  `kakao_access_token` text COLLATE utf8mb4_unicode_ci,
  `kakao_refresh_token` text COLLATE utf8mb4_unicode_ci,
