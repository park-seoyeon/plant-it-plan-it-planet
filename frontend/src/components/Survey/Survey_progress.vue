  ...
  methods: {
    startSurvey() {
      axios
        ...
        .then((response) => {
          this.question_list.question_number =
            response.data.question_list[this.where]['question_number'];
          this.question_list.question =
            response.data.question_list[this.where]['question'];
          this.question_list.answer_01 =
            response.data.question_list[this.where]['answer_01'];
          this.question_list.answer_02 =
            response.data.question_list[this.where]['answer_02'];
          this.question_list.answer_03 =
            response.data.question_list[this.where]['answer_03'];
          this.question_list.answer_04 =
            response.data.question_list[this.where]['answer_04'];
        });
    },
